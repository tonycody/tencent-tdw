...
create table tmp100 partition by list(int_data1) (PARTITION default) as select * from (select * from nulltest1 a join nulltest1 b on(a.int_data1=b.int_data2))dt;
